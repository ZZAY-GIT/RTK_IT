  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-4 mb-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="flex space-x-2 items-end">
          <button onClick={() => {}} disabled={loading} className="bg-blue-600 dark:bg-blue-700 text-white px-4 py-2 rounded-lg hover:bg-blue-700 dark:hover:bg-blue-800 disabled:opacity-50">{loading ? 'Загрузка...' : 'Применить'}</button>
